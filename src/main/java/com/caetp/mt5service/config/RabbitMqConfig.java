package com.caetp.mt5service.config;
...
public class RabbitMqConfig {
   ...
   /* @Bean
    public AMQP.Exchange exchange(){
        try {
            connection().createChannel(false).exchangeDeclare("amq.fanout", BuiltinExchangeType.FANOUT,true  );
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
